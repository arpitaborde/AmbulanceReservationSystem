		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				<div id="home" class="first-section"
					style="background-image: url('uploads/1.png');">
					<div class="container">
						<div class="row">
							<div class="col-md-12 col-sm-12 text-center">
								<div class="big-tagline">
									<h2 data-animation="animated zoomInRight">
										<strong>Ambulance Reservation System</strong>
									</h2>
		...
		<div class="container">
			<div class="section-title row text-center">
				<div class="col-md-8 col-md-offset-2">
					<h3>About Us</h3>
					<p class="lead">It is used for patients to, from or between
						places of medical treatment, such as hospital, dialysis center,
						Medical Appointments for non-urgent/ emergency care. Main aim of
						all such transfers is to maintain the continuity of medical care.</p>
				</div>
			</div>
			<!-- end title -->
			...
			<div class="row">
				<div class="col-md-6">
					<div class="message-box">
						<h4>Ambulance Reservation System</h4>
						<p class="lead">It is used for patients to, from or between
							places of medical treatment, such as hospital, dialysis center,
							Medical Appointments for non-urgent/ emergency care. Main aim of
							all such transfers is to maintain the continuity of medical care.</p>
			...
			<div class="row">
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="icon-wrapper wow fadeIn" data-wow-duration="1s"
						...
						<h3>ADVANCED LIFE SUPPORT AMBULANCE</h3>
					</div>
					<!-- end icon-wrapper -->
				</div>
				<div class="col-md-6 col-sm-6 col-xs-12">

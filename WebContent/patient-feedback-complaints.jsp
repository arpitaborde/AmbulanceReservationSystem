									...
									<form role="form" action="AddFeedback" method="post">
										...
										<div class="form-group">
											<label>Ambulance Vehicle No </label> <input
												class="form-control" type="text" name="avn" id="avn" placeholder="Ambulance Vehicle No"/>
										</div>
										<div class="form-group">
											<label>Driver Name</label> <input class="form-control"
												type="text" name="dname" id="dname" placeholder="Driver Name"/>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<textarea class="form-control" rows="3" name="feedback" id="feedback" placeholder="Feedback OR Complaint"></textarea>
										</div>
										<button type="submit" class="btn btn-info" id="btnValidate">Submit</button>
									</form>
								</div>
							</div>
						</div>
...
<script>
	 $(document).ready(function() {
         $("#btnValidate").click(function() {
             ...
             if (avn === "" ||dname ===""||type === ""||feedback === "")
             {
                 $("#avn").css("border-color", "red");

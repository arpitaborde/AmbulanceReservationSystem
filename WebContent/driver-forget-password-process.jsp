		...
		<div class="row">
			...
			<div class="panel panel-default">
				...
				<%
					...
					ResultSet resultPassword = DatabaseConnection.getResultFromSqlQuery("select upass from tbldriver where driver_email='" + email + "'");
				...
				<div class="panel-body">
					<div class="form-group">
						...
						<a href="driver-login.jsp">Click here to patient login</a>
					</div>
				</div>
				<%
					} else {

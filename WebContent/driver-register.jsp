						...
						<form action="DriverAccountCreate" method="post" name='driverRegister'>
							...
							<div class="form-group">
								<label>Driver Name</label> <input class="form-control"
									type="text" name="dname" id="dname" placeholder="Driver Name" onkeypress="return lettersValidate(event)"/>
							</div>
							<div class="form-group">
								<label>Email Id</label> <input class="form-control" type="text"
									name="demail" id="emailId"  placeholder="Email Id"/>
							</div>
							<div class="form-group">
								<label>Mobile No</label> <input class="form-control" type="text"
									name="dmobile" id="txtMB" onkeypress="return numberValidate(event)" maxlength="10" placeholder="Mobile No"/>
							</div>
							<div class="form-group">
								<label>Address</label> <input class="form-control" type="text"
									name="daddress" id="address" placeholder="Address"/>
							</div>
							<div class="form-group">
							...
							<button type="submit" class="btn btn-info" id="btnValidate">Create
								Account</button>
							<a class="for-pwd" href="driver-login.jsp">Already

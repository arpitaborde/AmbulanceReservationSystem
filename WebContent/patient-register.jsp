						...
						<form role="form" action="AccountCreate" method="post" name='patientRegister'>
							...
							<div class="form-group">
								<label>Patient Name</label> <input class="form-control"
									type="text" name="patientName" id="patientName" placeholder="Patient Name" onkeypress="return lettersValidate(event)"/>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label>Mobile No</label> <input class="form-control" type="text"
									...
									onkeypress="return numberValidate(event)" maxlength="10" placeholder="Mobile No"/>
							</div>
							<div class="form-group">
...
<script>
	 $(document).ready(function() {
         $("#btnValidate").click(function() {
             ...
             var uname = $("#uname").val();
             var upass = $("#upass").val();
             if (patientName === "" || emailId === "" || address ===""|| uname === "" || upass === "")
             {
